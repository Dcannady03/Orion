...
class CommandRouter:
    ...
    def handle(self, command: str) -> bool:
        ...
        elif dispatch_ai_team(
            self.orion,
            raw_command,
            interactive_approval=self.interactive_team_approval,
            approval_input=self._team_approval_input,
        ):
            pass
    ...
    def team_rollback(self, run_id: str):
        """Compatibility wrapper; Team coordination lives in the CLI adapter."""
        return AiTeamCliAdapter(self.orion).rollback(run_id)
