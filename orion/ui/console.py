...
BASE_COMMANDS = (
    "help", "home", "status", "briefing", "connect", "connect status", "connect health", "connect add gmail", "connect add microsoft", "connect add discord", "email", "email status", "email providers", "email connect gmail", "email connect microsoft", "email disconnect gmail", "email disconnect microsoft", "email configure gmail", "email configure microsoft", "email accounts", "email inbox", "email inbox gmail", "email inbox microsoft", "email unread", "email unread gmail", "email unread microsoft", "email search", "email read", "email thread", "email summarize", "email use gmail", "email use microsoft", "email draft", "email send", "email reply", "email forward", "email archive", "email trash", "email mark read", "email mark unread", "discord send", "image", "image status", "image providers", "image provider use", "image generate", "image history", "image show", "image save", "ai", "ai status", "ai connect openai", "ai test openai", "ai disconnect openai", "ai providers", "ai provider configure openai", "ai provider configure gemini", "ai provider use ollama", "ai provider use openai", "ai provider use gemini", "ai models", "ai profiles", "ai profile fast", "ai profile balanced", "ai profile coding", "ai profile research", "ai profile creative", "ai profile lightweight", "ai profile vision", "ai benchmark", "ai stats", "ai stats clear", "ai health", "ai route status", "ai route explain last", "change ollama model", "ollama model", "weather", "weather tomorrow", "network", "network status", "network watch", "network report", "network stop", "network config", "calendar", "calendar today", "calendar tomorrow", "calendar next", "calendar providers", "calendar enable google", "calendar enable microsoft", "calendar disable google", "calendar disable microsoft", "calendar configure google", "calendar configure microsoft", "calendar connect google", "calendar connect microsoft", "settings", "about", "profile", "config", "services",
    "plugins", "workspace", "files", "ls", "remember", "recall", "memory",
    "forget", "clear memory", "agent", "agent list", "agent show", "agent templates",
    "agent create", "agent edit", "agent delete", "agent enable", "agent disable",
    "agent validate", "agent promote", "agent copy", "agent test", "team", "team roles",
    "team role show", "team role set", "team role reset", "team create",
    "team agents add", "team plan", "team plan --manual", "team status",
    "team approve", "team implement", "team run", "team test", "team test last",
    "team docs", "team docs last", "team docs show", "team rollback",
    ...
    "goal", "goal plan", "goal explain", "goal preview", "goal capabilities",
    "goal classify", "goal validate",
    "goal proposal", "goal proposal create", "goal proposal show",
    "goal proposal list", "goal proposal validate", "goal proposal accept",
    "goal proposal reject",
    "events", "events status", "events list", "events show",
    "events correlation", "events subject", "events types",
    "events subscribers",
    ...
    "command-center department remove-agent", "command-center templates",
    "command-center template show", "command-center jobs",
    "command-center job create", "command-center job show",
    "command-center job launch", "command-center job launch --dry-run",
    "command-center job sync",
    "command-center job assign", "command-center job status",
    "command-center job progress", "command-center job cancel",
    "command-center activity", "command-center doctor",
    "cc", "cc status", "cc snapshot", "cc departments", "cc jobs",
    "cc job launch", "cc job launch --dry-run", "cc job sync", "cc job show",
    "cc activity", "cc doctor",
